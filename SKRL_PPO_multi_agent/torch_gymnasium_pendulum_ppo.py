...
try:
    ## OK listen up, num_envs=1 is important if windows
    ### num_envs=4 AND asynchronous=True MIGHT work on linux
    env = gym.vector.make("PandaReach-v3", num_envs=1, asynchronous=False, render_mode="human") #change to right env
...
# Start training with the WandbCallback
trainer.train()
